<?php
/**
 * this page is report of inlay lessons.
 * this report show that all the details about the lessons assigned to the system hours.
 */
        ...
        <div class="container-fluid text-center">    
            <div class="row content" >
                ...
                <div class="col-sm-10 text-left"style="margin-top:30px;"> 
                    <div class="container-fluid text-center">  
                        <h3 align="right" style="margin-right: 120px;">דוח שיבוץ שיעורים </h3>
                        <!--table-->
                        <center>
                            <table border="1" style="margin-right: 30px;" >
                                ...
                                <th><center>מקסימום נרשמים</center></th>
                                <th><center>מינימום נרשמים</center></th>
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                <tr>
                                  ...
                                  <td><?php echo $row['min_register'] ?></td>
