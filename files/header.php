          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right" >
                ...
                <ul class="dropdown-menu"  > 
                    <li ><a href="update_tab.php" style="text-align: right;">עדכון כרטיסיות</a></li>
                    <li><a href="subscription_update.php" style="text-align: right;">עדכון מנוי ללקוחות</a></li>
                </ul>
              </li>
                ...
                <ul class="dropdown-menu"style="padding: 5px;">
                    <li><a href="customer_register.php" style="text-align: right; ">רישום לקוח</a></li>
                    <li><a href="coach_register.php" style="text-align: right">רישום מאמן</a></li>
                </ul>
              </li>
                ...
                <ul class="dropdown-menu">
                    <li><a href="events.php" style="text-align: right;">מערכת שעות</a></li>
                    <li><a href="register_lesson.php" style="text-align: right">רישום שיעורים למאגר</a></li>
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="send_notification.php" style="text-align: right">הנחיות לשיעור</a></li>
                    <li><a href="complete_a_minimum_of_cover_in_class.php" style="text-align: right"> השלמת מכסה מינימלית<br> לשיעור</a></li> 
                </ul>
              </li>
                <li class="dropdown">
                <a href="#" style="width: 105px;color:#fff;" class="dropdown-toggle" data-toggle="dropdown" role="button">דוחות <span class="caret"></span></a>
                <ul class="dropdown-menu">
                    <li><a href="customer_report.php" style="text-align: right">דוח לקוחות</a></li>
                    <li><a href="lesson_report.php" style="text-align: right"> דוח שיעורים</a></li> 
                    <li><a href="coach_report.php" style="text-align: right">דוח מאמנים</a></li>
                    <li><a href="report_history_lesson.php" style="text-align: right"> דוח היסטוריית<br> רישומים</a></li> 
                    <li><a href="changes_report.php" style="text-align: right"> דוח שינויים</a></li> 
                    <li><a href="cancel_lesson_by_coaches_report.php" style="text-align: right;"> דוח ביטול שיעורים<br> על ידי מאמנים</a></li> 
                    <li><a href="inlay_Lesson_report.php" style="text-align: right"> דוח שיבוץ שיעורים</a></li> 
                </ul>
              </li>
            </ul>
